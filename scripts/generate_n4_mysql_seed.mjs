...
const sourcePath = "database/import/jlpt_n4_vocabulary_by_chapter_topic.json";
const strictJsonPath = "database/import/jlpt_n4_vocabulary_db_import.json";
const sqlPath = "database/seed/003_jlpt_n4_vocabulary.sql";
...
function strictTopic(topic) {
  return {
    id: topic.id,
    name: `N4-C${String(topic.chapter_number).padStart(2, "0")}S${String(topic.section_number).padStart(2, "0")} - ${topic.name}`,
...
const strict = {
  metadata: {
    name: "JLPT N4 strict database import data",
