...
const sourcePath = "database/import/jlpt_n3_vocabulary_by_chapter_topic.json";
const strictJsonPath = "database/import/jlpt_n3_vocabulary_db_import.json";
const sqlPath = "database/seed/004_jlpt_n3_vocabulary.sql";
...
function strictTopic(topic) {
  return {
    id: topic.id,
    name: `N3-C${String(topic.chapter_number).padStart(2, "0")}S${String(topic.section_number).padStart(2, "0")} - ${topic.name}`,
...
const strict = {
  metadata: {
    name: "JLPT N3 strict database import data",
